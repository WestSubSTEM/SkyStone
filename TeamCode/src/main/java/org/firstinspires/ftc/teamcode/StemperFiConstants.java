...
public class StemperFiConstants {
    ...
    public static final double FOUNDATION_SERVO_LEFT_UP = 0.0;
    public static final double FOUNDATION_SERVO_LEFT_DOWN = 1.0;

    public static final double FOUNDATION_SERVO_RIGHT_UP = 0.0;
    public static final double FOUNDATION_SERVO_RIGHT_DOWN = 1.0;

    public static final double SKYSTONE_SERVO_OPEN = 0.8;
